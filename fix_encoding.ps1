# PowerShell script to fix MySQL character encoding
...
# Create the SQL script content with proper encoding
$sqlContent = @"
...
# Write the SQL content to a file with UTF-8 encoding
$sqlContent | Out-File -FilePath "fix_encoding_temp.sql" -Encoding UTF8

# Execute the MySQL command
& $mysqlPath -u $user -p$password $database -e "source fix_encoding_temp.sql"

# Clean up
Remove-Item "fix_encoding_temp.sql" -ErrorAction SilentlyContinue

Write-Host "Character encoding fix completed!" 