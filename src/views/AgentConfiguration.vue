...
const columnConfigs: ColumnConfig[] = [
  ...
  { key: 'agentId_1', title: 'Agent ID', dataIndex: 'agentId', width: 150, sorter: (a: any, b: any) => (a.agentId || '').localeCompare(b.agentId || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'agentName_2', title: 'Agent名称', dataIndex: 'agentName', width: 180, sorter: (a: any, b: any) => (a.agentName || '').localeCompare(b.agentName || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'ipName_3', title: 'IP名称', dataIndex: 'ipName', width: 100, sorter: (a: any, b: any) => (a.ipName || '').localeCompare(b.ipName || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'vad_4', title: 'VAD', dataIndex: 'vad', width: 100, sorter: (a: any, b: any) => (a.vad || '').localeCompare(b.vad || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'asr_5', title: 'ASR', dataIndex: 'asr', width: 120, sorter: (a: any, b: any) => (a.asr || '').localeCompare(b.asr || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'intentRecognition_6', title: '意图识别', dataIndex: 'intentRecognition', width: 120, sorter: (a: any, b: any) => (a.intentRecognition || '').localeCompare(b.intentRecognition || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'knowledgeBase_7', title: '智能体', dataIndex: 'knowledgeBase', width: 120, sorter: (a: any, b: any) => (a.knowledgeBase || '').localeCompare(b.knowledgeBase || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'llm_8', title: 'LLM', dataIndex: 'llm', width: 120, sorter: (a: any, b: any) => (a.llm || '').localeCompare(b.llm || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'memory_9', title: 'Memory', dataIndex: 'memory', width: 100, sorter: (a: any, b: any) => (a.memory || '').localeCompare(b.memory || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'tools_10', title: '工具', dataIndex: 'tools', width: 150, sorter: (a: any, b: any) => (a.tools || '').localeCompare(b.tools || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'tts_11', title: 'TTS', dataIndex: 'tts', width: 100, sorter: (a: any, b: any) => (a.tts || '').localeCompare(b.tts || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'ttsCombinationName_12', title: 'TTS音色名称', dataIndex: 'ttsCombinationName', width: 120, sorter: (a: any, b: any) => (a.ttsCombinationName || '').localeCompare(b.ttsCombinationName || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'ipVcm_13', title: 'IP VCM', dataIndex: 'ipVcm', width: 120, sorter: (a: any, b: any) => (a.ipVcm || '').localeCompare(b.ipVcm || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'vcmCombinationName_14', title: 'VCM音色名称', dataIndex: 'vcmCombinationName', width: 120, sorter: (a: any, b: any) => (a.vcmCombinationName || '').localeCompare(b.vcmCombinationName || ''), sortDirections: ['ascend', 'descend'] },
  { key: 'updater_15', title: '更新人', dataIndex: 'updater', width: 100, sorter: (a: any, b: any) => (a.updater || '').localeCompare(b.updater || ''), sortDirections: ['ascend', 'descend'] },
