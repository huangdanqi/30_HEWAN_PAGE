...
const columnConfigs: ColumnConfig[] = [
  ...
  { key: 'memberId_1', title: '主账户ID', dataIndex: 'memberId', width: 150 },
  { key: 'phoneNumber_2', title: '手机号', dataIndex: 'phoneNumber', width: 120 },
  { key: 'deviceModel_3', title: '设备型号', dataIndex: 'deviceModel', width: 100 },
  { key: 'deviceId_4', title: '设备ID', dataIndex: 'deviceId', width: 200 },
  { key: 'ipRole_5', title: 'IP角色', dataIndex: 'ipRole', width: 100 },
  { key: 'productId_6', title: '产品ID', dataIndex: 'productId', width: 120 },
  { key: 'commodityId_7', title: '商品ID', dataIndex: 'commodityId', width: 150 },
  { key: 'voiceCloningModelId_8', title: '音色复刻模型ID', dataIndex: 'voiceCloningModelId', width: 180 },
  { key: 'initialActivationTime_9', title: '首次激活时间', dataIndex: 'initialActivationTime', width: 150, sorter: (a, b) => new Date(a.initialActivationTime).getTime() - new Date(b.initialActivationTime).getTime(), sortDirections: ['ascend', 'descend'] },
  { key: 'currentMemberType_10', title: '当前会员类型', dataIndex: 'currentMemberType', width: 120 },
  { key: 'memberPayment_11', title: '会员付费', dataIndex: 'memberPayment', width: 120 },
  { key: 'memberActivationTime_12', title: '会员激活时间', dataIndex: 'memberActivationTime', width: 150, sorter: (a, b) => new Date(a.memberActivationTime).getTime() - new Date(b.memberActivationTime).getTime(), sortDirections: ['ascend', 'descend'] },
  { key: 'memberExpirationTime_13', title: '会员到期时间', dataIndex: 'memberExpirationTime', width: 150, sorter: (a, b) => new Date(a.memberExpirationTime).getTime() - new Date(b.memberExpirationTime).getTime(), sortDirections: ['ascend', 'descend'] },
  { key: 'fourGCardNumber_14', title: '4G卡号', dataIndex: 'fourGCardNumber', width: 120 },
  { key: 'fourGPlan_15', title: '4G套餐', dataIndex: 'fourGPlan', width: 100 },
  { key: 'remainingDataCurrentMonth_16', title: '当月剩余流量', dataIndex: 'remainingDataCurrentMonth', width: 120 },
  { key: 'fourGPayment_17', title: '4G付费', dataIndex: 'fourGPayment', width: 100 },
  { key: 'fourGActivationTime_18', title: '4G激活时间', dataIndex: 'fourGActivationTime', width: 150, sorter: (a, b) => new Date(a.fourGActivationTime).getTime() - new Date(b.fourGActivationTime).getTime(), sortDirections: ['ascend', 'descend'] },
  { key: 'fourGExpirationTime_19', title: '4G到期时间', dataIndex: 'fourGExpirationTime', width: 150, sorter: (a, b) => new Date(a.fourGExpirationTime).getTime() - new Date(b.fourGExpirationTime).getTime(), sortDirections: ['ascend', 'descend'] },
  { key: 'annualServiceFeeBalance_20', title: '服务年费用盈余', dataIndex: 'annualServiceFeeBalance', width: 150, sorter: (a, b) => a.annualServiceFeeBalance - b.annualServiceFeeBalance, sortDirections: ['ascend', 'descend'] },
  { key: 'asrUsage_21', title: 'ASR用量', dataIndex: 'asrUsage', width: 120 },
  { key: 'llmUsage_22', title: 'LLM用量', dataIndex: 'llmUsage', width: 120 },
  { key: 'ttsUsage_23', title: 'TTS用量', dataIndex: 'ttsUsage', width: 120 },
  { key: 'voiceCloneUsage_24', title: '音色克隆用量', dataIndex: 'voiceCloneUsage', width: 150 },
  { key: 'registrationTime_25', title: '注册时间', dataIndex: 'registrationTime', width: 150, sorter: (a, b) => new Date(a.registrationTime).getTime() - new Date(b.registrationTime).getTime(), sortDirections: ['ascend', 'descend'] },
];
...
for (let i = 0; i < 100; i++) {
  ...
  rawData.push({
    key: i + 1,
    memberId: `jhg824&3*g${i % 10}`,
    phoneNumber: `180****${7950 + (i % 10)}`,
    deviceModel: `HWZ00${i % 2 === 0 ? '1' : '2'}`,
    deviceId: `D075415252TD250019252GJL`,
    ipRole: i % 2 === 0 ? '王龙' : '张三',
    productId: `HWZ00100${i % 3}`,
    commodityId: `hjhwn832nj${i}`,
    voiceCloningModelId: `hjhwn832nj${i}`,
    ...
    remainingDataCurrentMonth: `${(20 + (i % 5))}M`,
    ...
    annualServiceFeeBalance: 26.35 + (i % 5),
    asrUsage: `384,3848 tokens`,
    llmUsage: `384,3848 tokens`,
    ttsUsage: `213.55 h`,
    voiceCloneUsage: `213.55 h`,
